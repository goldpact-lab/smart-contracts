...
contract GOTERC20Token is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20("GOLDEN PACT", "GOT", 9) {}
...
contract GOT is GOTERC20Token {
    ...
    constructor(address _feeReceiver, address _buyFeeReceiver, uint _buyFeeRatio)  GOTERC20Token() {
